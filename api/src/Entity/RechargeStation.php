...
#[ApiResource]
#[ApiFilter(\ApiPlatform\Doctrine\Orm\Filter\SearchFilter::class, properties: ["adress"=>"ipartial", "speedType"=>"ipartial", "connectionType"=>"ipartial", "power", "currentType"=>"ipartial"])]
